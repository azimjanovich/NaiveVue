                ...
                <div class="flex-1">
                    ...
                    <div class="mt-8">
                        ...
                        <div class="mt-6 text-sm flex justify-center text-gray-400">
                            <LogoGoogle class="max-w-[35px] m-2 cursor-pointer hover:text-red-500 duration-300" />
                            <LogoFacebook class="max-w-[35px] m-2 cursor-pointer hover:text-blue-800 duration-300" />
                        </div>
                    </div>
                </div>
            </div>
